...
The task table now supports shift-click multi-select for bulk operations. Select a range, retry them all, export to CSV, or mark as reviewed—whatever your workflow needs.
