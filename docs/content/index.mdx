...
Kanchi connects directly to your message broker, and gives you real-time visibility into task execution. Tasks, workers, retries, failures, everything you need to debug issues and prevent outages.
...
Open [http://localhost:3000/ui](http://localhost:3000/ui) and you're done. The UI, API, WebSocket endpoint, and docs are served by one FastAPI process.
